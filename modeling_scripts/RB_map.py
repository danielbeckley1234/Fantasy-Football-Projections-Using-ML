...
RB_lag1s = ['Snaps/G', 'significant_injury','RusY/A', 'RYOE/ATT', 'RYOE%', 'Rush%', 'Routes/G', 'Open',
            'Catch', 'YAC', 'Overall', 'Tgt%', 'Y/RR', 'RusTD%', 'xRusTD%', 'RecTD%', 'xRecTD%']
RB_lag2s = ['In5ATT/G', 'In5Rush%', 'In5REC/G', 'In5TG/G']
...
RB_rush_base_features = ['ATT/G', 'ATT/G_lag1', 'ATT/G_lag2', 'ATT/G_lag3', 'ATT/G_std3',
    ...
    'RYOE%', 'RYOE%_lag1', 'Rush%', 'Rush%_lag1']
