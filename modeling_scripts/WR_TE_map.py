...
WRTE_counting = WRTE_targets + ['RZREC', 'RZTGT', 'RZATT', 'Routes']
WRTE_lag1s = ['RecTD%', 'RuTD%', 'xRecTD%', 'xRuTD%', 'significant_injury', 'Snaps/G',
              'SNAP %', 'RUSH %', 'TGT %', 'TOUCH %', 'YPRR', 'Open', 'Catch', 'YAC', 'Overall',
              'CUSH', 'SEP', 'TAY', 'TAY%', 'CTCH%', 'YAC/R', 'xYAC/R', '+/-', 'Routes/G']
WRTE_lag2s = ['RZREC/G', 'RZTGT/G', 'RZTGT%']
...
WR_TE_target_feature_map = {
    ...
    'RusTD': ['RusTD/G', 'RusTD/G_lag1', 'RZATT/G',
        'RusTD%', 'xRusTD%', 'xRusTD%_lag1'] + WRTE_cross_features + WRTE_rush_base_features,
